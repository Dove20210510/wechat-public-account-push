  ...
  USERS: [
    {
      ...
      id: 'PDU18593TtLAedI0n3pu3xCP7uNyhzug3Y3oSqIsx',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '猪猪', year: '1995', date: '06-20',
        },
        {
          type: '节日', name: '相恋纪念日', year: '2021', date: '05-10',
        },
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2021-05-10' },
        // 结婚纪念日
